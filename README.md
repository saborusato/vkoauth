Модуль с функциями для прохождения авторизации пользователя ВКонтакте по протоколу OAuth 2.0, с дополнениями, соответствующими документации https://dev.vk.com/
